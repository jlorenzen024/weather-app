...
label2 = customtkinter.CTkLabel(master=frame, text=[data1], font = ('Roboto', 16))
label2.pack(pady=12, padx=10)

label3 = customtkinter.CTkLabel(master=frame, text=[data2], font = ('Roboto', 16))
label3.pack(pady=12, padx=10)

label4 = customtkinter.CTkLabel(master=frame, text=[data3], font = ('Roboto', 16))
label4.pack(pady=12, padx=10)

label5 = customtkinter.CTkLabel(master=frame, text=[data4], font = ('Roboto', 16))
label5.pack(pady=12, padx=10)

label6 = customtkinter.CTkLabel(master=frame, text=[data5], font = ('Roboto', 16))
label6.pack(pady=12, padx=10)

label7 = customtkinter.CTkLabel(master=frame, text=[data6], font = ('Roboto', 16))
label7.pack(pady=12, padx=10)

label8 = customtkinter.CTkLabel(master=frame, text=[data7], font = ('Roboto', 16))
